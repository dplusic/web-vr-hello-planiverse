...
export class Demo {
  ...
  createMeshes() {
    // Box1
    this._box1 = new THREE.Mesh(new THREE.BoxGeometry(0.03, 1, 1), new THREE.MeshNormalMaterial())
    this._box1.position.y = 1.5
    this._box1.position.z = -7

    // Box2
    this._box2 = new THREE.Mesh(new THREE.BoxGeometry(0.1, 3, 3), new THREE.MeshNormalMaterial())
    this._box2.position.y = -1
    this._box2.position.z = -21
